...
def test_main_app_starts_successfully(
    mock_singleton, mock_load_config, mock_calculate_schedule, mock_setup_logging, mock_scheduler_loop, mock_thread
):
    """
...
@patch("main_app.load_config")
@patch("main_app.singleton")
def test_main_app_exits_on_config_failure(
    mock_singleton, mock_load_config, mock_calculate_schedule, mock_setup_logging, mock_scheduler_loop, mock_thread
):
    """
