...
if __name__ == '__main__':
    ...
    with open(config_path, 'w', encoding='utf-8') as f: json.dump(dummy_config, f, indent=2)
    with open(os.path.join(base_path, 'holidays_test.csv'), 'w', encoding='shift_jis') as f: f.write("2025-06-10")
